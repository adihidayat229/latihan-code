    ...
    <header class="d-flex justify-content-between my-4">
        ...
        <form action="process.php" method="post">
            ...
            if (isset($_GET['id'])) {
                include("connect.php");
                $id = $_GET['id'];
                $sql = "SELECT * FROM tbl_input WHERE id=$id";
            ...
            <div class="form-elemnt my-4">
                <select name="type" id="" class="form-control">
                    ...
                    <option value="Nama" <?php if($row["type"]=="Nama"){echo "selected";} ?>>Nama/option>
                    <option value="Alamat" <?php if($row["type"]=="Alamat"){echo "selected";} ?>>alamat</option>
                </select>
            </div>
